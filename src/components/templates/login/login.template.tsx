...
export const TpLogin: React.FC<Props> = (props) => {
  const {id, defaultIdValue, idValue, factoryValue, disabled, savedIdChecked, factoryList, form, onChangeCbo, onChangeId, onChangePw, onLogin, onSavedIdChecked} = props;
    ...
    <ScContainer>
      <Flexbox height='100vh' width='100%'>
        <Space
          ...
          align='center'>
          <Space style={{ maxWidth: 800, height: '100%', overflow: 'hidden' }}>
            <ScImg
              src={img_login}
              style={{
                width: '40vw',
