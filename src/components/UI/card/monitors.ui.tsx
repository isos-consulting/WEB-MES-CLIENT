...
import MonitorCard, { ICreateMonitorProps, IDefineMonitorProps } from "~/components/UI/card/monitor.ui";
...
export const MonitorCards: React.FC<ITpMonitorCardsProps> = (
  ...
  const equips:ICreateMonitorProps[] = props.equips.map((defineEquipProps: IDefineMonitorProps) => {
