...
export const ScInputbox = styled(BaseInput)`
  width: ${(props) => 
    props.widthSize === 'default' ? Sizes.width_input_md :
    props.widthSize === 'flex' ? '100%' : Sizes.width_input_md 
  };
...
export const ScInputPasswordbox = styled(PasswordInput)`
  width: ${(props) => 
    props.widthSize === 'default' ? Sizes.width_input_lg :
    props.widthSize === 'flex' ? '100%' : Sizes.width_input_lg 
  };
...
export const ScInputNumberbox = styled(BaseInput)`
  width: ${(props) => 
    props.widthSize === 'default' ? Sizes.width_inputNumber_md :
    props.widthSize === 'flex' ? '100%' : Sizes.width_inputNumber_md 
  };
