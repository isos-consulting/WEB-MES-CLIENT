...
export const PgAdmPatternOpt = () => {
  ...
  const searchUriPath = URL_PATH_ADM.PATTERN_OPT.GET.PATTERN_OPTS;
  const saveUriPath = URL_PATH_ADM.PATTERN_OPT.PUT.PATTERN_OPTS;

  /** 그리드 상태를 관리 */
  const grid = useGrid('GRID', [
    {header: '자동발행옵션UUID', name:'pattern_opt_uuid', alias:'uuid', width:150, filter:'text', hidden:true},
    {header: '자동발행옵션코드', name:'pattern_opt_cd', width:ENUM_WIDTH.M, filter:'text', editable:true, requiredField:true},
    {header: '자동발행옵션명', name:'pattern_opt_nm', width:ENUM_WIDTH.L, filter:'text', editable:true, requiredField:true},
    {header: '테이블명', name:'table_nm', width:ENUM_WIDTH.L, filter:'text', editable:true, requiredField:true},
    {header: '자동발행여부', name:'auto_fg', width:ENUM_WIDTH.S, format:'check', editable:true, requiredField:true},
    {header: '컬럼명', name:'col_nm', width:ENUM_WIDTH.L, filter:'text', editable:true},
    {header: '패턴', name:'pattern', width:ENUM_WIDTH.L, filter:'text', editable:true},
