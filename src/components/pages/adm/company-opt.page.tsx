...
export const PgAdmCompanyOpt = () => {
  ...
  const searchUriPath = URL_PATH_ADM.COMPANY_OPT.GET.COMPANY_OPTS;
  const saveUriPath = URL_PATH_ADM.COMPANY_OPT.PUT.COMPANY_OPTS;

  /** 그리드 상태를 관리 */
  const grid = useGrid('GRID', [
    {header: '회사옵션UUID', name:'company_opt_uuid', alias:'uuid', width:150, filter:'text', hidden:true},
    {header: '회사옵션코드', name:'company_opt_cd', width:ENUM_WIDTH.M, filter:'text', editable:true, requiredField:true},
    {header: '회사옵션명', name:'company_opt_nm', width:ENUM_WIDTH.L, filter:'text', editable:true, requiredField:true},
    {header: '비고', name:'remark', width:ENUM_WIDTH.L, filter:'text', editable:true},
    {header: '값', name:'val', width:ENUM_WIDTH.L, filter:'text', editable:true},
    {header: '상세옵션', name:'val_opt', width:ENUM_WIDTH.L, filter:'text', editable:true},
