...
export const PgAdmTranType = () => {
  ...
  const searchUriPath = URL_PATH_ADM.TRAN_TYPE.GET.TRAN_TYPES;
  const saveUriPath = URL_PATH_ADM.TRAN_TYPE.PUT.TRAN_TYPES;

  /** 그리드 상태를 관리 */
  const grid = useGrid('GRID', [
    {header: '수불유형UUID', name:'tran_type_uuid', alias:'uuid', width:150, filter:'text', hidden:true},
    {header: '수불유형코드', name:'tran_type_cd', width:ENUM_WIDTH.M, filter:'text', editable:true, requiredField:true},
    {header: '수불유형명', name:'tran_type_nm', width:ENUM_WIDTH.L, filter:'text', editable:true, requiredField:true},
