...
export const PgAdmInspType = () => {
  ...
  const searchUriPath = URL_PATH_ADM.INSP_TYPE.GET.INSP_TYPES;
  const saveUriPath = URL_PATH_ADM.INSP_TYPE.PUT.INSP_TYPES;

  /** 그리드 상태를 관리 */
  const grid = useGrid('GRID', [
    {header: '검사유형UUID', name:'insp_type_uuid', alias:'uuid', width:150, filter:'text', hidden:true},
    {header: '검사유형코드', name:'insp_type_cd', width:ENUM_WIDTH.M, filter:'text', editable:true, requiredField:true},
    {header: '검사유형명', name:'insp_type_nm', width:ENUM_WIDTH.L, filter:'text', editable:true, requiredField:true},
