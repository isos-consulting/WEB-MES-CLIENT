...
export const PgAdmBomType = () => {
  ...
  const searchUriPath = URL_PATH_ADM.BOM_TYPE.GET.BOM_TYPES;
  const saveUriPath = URL_PATH_ADM.BOM_TYPE.PUT.BOM_TYPES;

  /** 그리드 상태를 관리 */
  const grid = useGrid('GRID', [
    {header: 'BOM구성유형 UUID', name:'bom_type_uuid', alias:'uuid', width:150, filter:'text', hidden:true},
    {header: 'BOM구성유형 코드', name:'bom_type_cd', width:ENUM_WIDTH.L, filter:'text', editable:true, requiredField:true},
    {header: 'BOM구성유형명', name:'bom_type_nm', width:ENUM_WIDTH.L, filter:'text', editable:true, requiredField:true},
