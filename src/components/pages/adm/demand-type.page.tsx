...
export const PgAdmDemandType = () => {
  ...
  const grid = useGrid('GRID', [
    {header: '요청유형UUID', name:'demand_type_uuid', alias:'uuid', width:150, filter:'text', hidden:true},
    {header: '요청유형코드', name:'demand_type_cd', width:ENUM_WIDTH.M, filter:'text', editable:true, requiredField:true},
    {header: '요청유형명', name:'demand_type_nm', width:ENUM_WIDTH.L, filter:'text', editable:true, requiredField:true},
