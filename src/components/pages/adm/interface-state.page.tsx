...
/** 주기단위 */
export const PgAdmInterfaceState = () => {
  /** 페이지 제목 */
  ...
  const searchUriPath = URL_PATH_ADM.INTERFACE_STATE.GET.INTERFACE_STATES;
  const saveUriPath = URL_PATH_ADM.INTERFACE_STATE.PUT.INTERFACE_STATES;

  /** 그리드 상태를 관리 */
  const grid = useGrid('GRID', [
    {header: '인터페이스 상태UUID', name:'interface_state_uuid', alias:'uuid', width:150, filter:'text', hidden:true},
    {header: '인터페이스 상태코드', name:'interface_state_cd', width:ENUM_WIDTH.L, filter:'text', editable:true, requiredField:true},
    {header: '인터페이스 상태명', name:'interface_state_nm', width:ENUM_WIDTH.L, filter:'text', editable:true, requiredField:true},
