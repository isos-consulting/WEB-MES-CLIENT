...
/** 주기단위 */
export const PgAdmFileMgmtType = () => {
  /** 페이지 제목 */
  ...
  const searchUriPath = URL_PATH_ADM.FILE_MGMT_TYPE.GET.FILE_MGMT_TYPES;
  const saveUriPath = URL_PATH_ADM.FILE_MGMT_TYPE.PUT.FILE_MGMT_TYPES;

  /** 그리드 상태를 관리 */
  const grid = useGrid('GRID', [
    {header: '파일관리유형UUID', name:'file_mgmt_type_uuid', alias:'uuid', width:150, filter:'text', hidden:true},
    {header: '파일관리유형코드', name:'file_mgmt_type_cd', width:ENUM_WIDTH.M, filter:'text', editable:true, requiredField:true},
    {header: '파일관리유형명', name:'file_mgmt_type_nm', width:ENUM_WIDTH.L, filter:'text', editable:true, requiredField:true},
