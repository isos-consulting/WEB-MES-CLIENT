...
export const PgAdmPrdPlanType = () => {
  ...
  const searchUriPath = URL_PATH_ADM.PRD_PLAN_TYPE.GET.PRD_PLAN_TYPES;
  const saveUriPath = URL_PATH_ADM.PRD_PLAN_TYPE.PUT.PRD_PLAN_TYPES;

  /** 그리드 상태를 관리 */
  const grid = useGrid('GRID', [
    {header: '생산계획유형UUID', name:'prd_plan_type_uuid', alias:'uuid', width:150, filter:'text', hidden:true},
    {header: '생산계획유형코드', name:'prd_plan_type_cd', width:ENUM_WIDTH.M, filter:'text', editable:true, requiredField:true},
    {header: '생산계획유형명', name:'prd_plan_type_nm', width:ENUM_WIDTH.L, filter:'text', editable:true, requiredField:true},
