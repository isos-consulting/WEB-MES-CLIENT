...
/** 일상점검주기 */
export const PgAdmDailyInspCycle = () => {
  /** 페이지 제목 */
  ...
  const searchUriPath = URL_PATH_ADM.DAILY_INSP_CYCLE.GET.DAILY_INSP_CYCLES;
  const saveUriPath = URL_PATH_ADM.DAILY_INSP_CYCLE.PUT.DAILY_INSP_CYCLES;

  /** 그리드 상태를 관리 */
  const grid = useGrid('GRID', [
    {header: '일상점검주기UUID', name:'daily_insp_cycle_uuid', alias:'uuid', width:150, filter:'text', hidden:true},
    {header: '일상점검주기코드', name:'daily_insp_cycle_cd', width:150, filter:'text', editable:true, requiredField:true},
    {header: '일상점검주기명', name:'daily_insp_cycle_nm', width:200, filter:'text', editable:true, requiredField:true},
  ], {
