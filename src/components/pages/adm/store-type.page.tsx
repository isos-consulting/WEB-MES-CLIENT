...
export const PgAdmStoreType = () => {
  ...
  const searchUriPath = URL_PATH_ADM.STORE_TYPE.GET.STORE_TYPES;
  const saveUriPath = URL_PATH_ADM.STORE_TYPE.PUT.STORE_TYPES;

  /** 그리드 상태를 관리 */
  const grid = useGrid('GRID', [
    {header: '창고유형UUID', name:'store_type_uuid', alias:'uuid', width:150, filter:'text', hidden:true},
    {header: '창고유형코드', name:'store_type_cd', width:ENUM_WIDTH.M, filter:'text', editable:true, requiredField:true},
    {header: '창고유형명', name:'store_type_nm', width:ENUM_WIDTH.L, filter:'text', editable:true, requiredField:true},
    {header: '매개변수명', name:'parameter_nm', width:ENUM_WIDTH.L, filter:'text', editable:true},
