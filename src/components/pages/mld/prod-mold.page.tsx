...
export const PgMldProdMold = () => {
  ...
  const headerGrid = useGrid('HEADER_GRID', [
    ...
    {header: '품번', name:'prod_no', width:ENUM_WIDTH.M, filter:'text', hidden:true},
    ...
    {header: '품목 유형명', name:'item_type_nm', width:ENUM_WIDTH.L, filter:'text'},
    {header: '제품 유형UUID', name:'prod_type_uuid', width:ENUM_WIDTH.M, filter:'text', hidden:true},
    {header: '제품 유형명', name:'prod_type_nm', width:ENUM_WIDTH.L, filter:'text'},
  ...
  const detailGrid = useGrid('DETAIL_GRID', [
    {header: '품목별 금형정보UUID', name:'prod_mold_uuid', alias:'uuid', width:ENUM_WIDTH.M, filter:'text', hidden:true},
    {header: '품목UUID', name:'prod_uuid', width:ENUM_WIDTH.M, filter:'text', hidden:true},
    {header: '품번', name:'prod_no', width:ENUM_WIDTH.M, filter:'text', hidden:true},
    {header: '품명', name:'prod_nm', width:ENUM_WIDTH.L, filter:'text', hidden:true},
    {header: '품목 유형UUID', name:'item_type_uuid', width:ENUM_WIDTH.M, filter:'text', hidden:true},
    {header: '품목 유형명', name:'item_type_nm', width:ENUM_WIDTH.L, filter:'text', hidden:true},
    {header: '제품 유형UUID', name:'prod_type_uuid', width:ENUM_WIDTH.M, filter:'text', hidden:true},
    {header: '제품 유형명', name:'prod_type_nm', width:ENUM_WIDTH.L, filter:'text', hidden:true},
    {header: '모델UUID', name:'model_uuid', width:ENUM_WIDTH.M, filter:'text', hidden:true},
    {header: '모델명', name:'model_nm', width:ENUM_WIDTH.L, filter:'text', hidden:true},
    {header: '리비전', name:'rev', width:ENUM_WIDTH.S, filter:'text', hidden:true},
    {header: '규격', name:'prod_std', width:ENUM_WIDTH.L, filter:'text', hidden:true},
    {header: '단위UUID', name:'unit_uuid', width:ENUM_WIDTH.L, filter:'text', hidden:true},
    {header: '단위명', name:'unit_nm', width:ENUM_WIDTH.L, filter:'text', hidden:true},
    {header: '금형UUID', name:'mold_uuid', width:ENUM_WIDTH.M, hidden:true},
    {header: '금형코드', name:'mold_cd', width:ENUM_WIDTH.M, format:'popup', editable:true},
    {header: '금형명', name:'mold_nm', width:ENUM_WIDTH.L, format:'popup', filter:'text', editable:true, requiredField:true},
  ], {
  ...
  const moldPopupInfo = {
    ...
    columns: [
      {header: '금형UUID', name:'mold_uuid', width:ENUM_WIDTH.M, format:'text', hidden:true},
      {header: '금형코드', name:'mold_cd', width:ENUM_WIDTH.M, format:'text'},
      {header: '금형명', name:'mold_nm', width:ENUM_WIDTH.L, format:'text'},
    ],
    dataApiSettings: {
  ...
  const detailInputInfo = useInputGroup('DETAIL_INPUTBOX', [
    ...
    {type:'text', id:'model_uuid', label: '모델UUID', disabled:true, hidden:true},
