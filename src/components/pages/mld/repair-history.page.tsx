...
export const PgMldRepairHistory = () => {
  ...
  const grid = useGrid('GRID', [
    {header: '금형 수리이력 관리UUID', name:'repair_history_uuid', alias:'uuid', width:150, filter:'text', hidden:true},
    {header: '금형UUID', name:'mold_uuid', width:150, filter:'text', hidden:true},
    {header: '금형명', name:'mold_nm', width:ENUM_WIDTH.L, filter:'text', format:'popup', editable:true, requiredField:true},
    ...
    {header: '품목명', name:'prod_nm', width:ENUM_WIDTH.L, filter:'text', format:'popup', editable:true},
    {header: '품목 유형명', name:'item_type_nm', width:ENUM_WIDTH.L, filter:'text', format:'popup', editable:true},
    {header: '제품 유형명', name:'prod_type_nm', width:ENUM_WIDTH.L, filter:'text', format:'popup', editable:true},
    {header: '모델명', name:'model_nm', width:ENUM_WIDTH.L, filter:'text', format:'popup',editable:true},
    {header: '리비전', name:'rev', width:ENUM_WIDTH.S, filter:'text', format:'popup',editable:true},
    {header: '규격', name:'prod_std', width:ENUM_WIDTH.XL, filter:'text', format:'popup',editable:true},
    {header: '단위명', name:'unit_nm', width:ENUM_WIDTH.L, filter:'text', format:'popup',editable:true},
    {header: '금형 문제점UUID', name:'problem_uuid', width:150, filter:'text', hidden:true},
    {header: '금형 문제점명', name:'problem_nm', width:ENUM_WIDTH.L, filter:'text', format:'popup', editable:true, requiredField:true},
    {header: '발생 일자', name:'occur_date', width:ENUM_WIDTH.M, filter:'text', editable:true, format:'date'},
    {header: '발생확인자UUID', name:'occur_emp_uuid', width:150, filter:'text', format:'popup',hidden:true},
    {header: '발생확인자명', name:'occur_emp_nm', width:ENUM_WIDTH.L, filter:'text', format:'popup',editable:true},
    {header: '수리자UUID', name:'repair_emp_uuid', width:150, filter:'text', format:'popup',hidden:true},
    {header: '수리자명', name:'repair_emp_nm', width:ENUM_WIDTH.L, filter:'text', format:'popup',editable:true},
    {header: '수리업체', name:'repair_partner', width:ENUM_WIDTH.L, filter:'text', editable:true},
    {header: '수리번호', name:'repair_no', width:ENUM_WIDTH.L, filter:'text', editable:true},
    {header: '수리시작일자', name:'start_date', width:ENUM_WIDTH.M, filter:'text', editable:true, format:'date', requiredField:true},
    {header: '수리완료일자', name:'end_date', width:ENUM_WIDTH.M, filter:'text', editable:true, format:'date'},
    {header: '수리내용', name:'contents', width:ENUM_WIDTH.XL, filter:'text', editable:true},
  ], {
