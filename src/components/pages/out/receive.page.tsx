...
export const PgOutReceive = () => {
  ...
  const detailGrid = useGrid('DETAIL_GRID', [
    ...
    {header: '환율', name:'exchange', width:ENUM_WIDTH.M, filter:'number', format:'number', editable:true, requiredField:true, 
      formula: {
        targetColumnNames:['qty', 'price'], resultColumnName:'total_price',
        formula: priceFormula
      }
    },
    {header: '발주량', name:'order_qty', width:ENUM_WIDTH.M,filter:'number', format:'number'},
