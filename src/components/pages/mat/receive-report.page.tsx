    ...
    switch (searchInfo.values?.sort_type) {
      case 'prod':
        _columns = [
          ...
          {header: '입고수량', name:'income_qty', width:ENUM_WIDTH.M, decimal:ENUM_DECIMAL.DEC_STCOK, format:'number', filter:'number'},
          ...
          {header: '불합격수량', name:'reject_qty', width:ENUM_WIDTH.M, decimal:ENUM_DECIMAL.DEC_STCOK, format:'number', filter:'number'},
