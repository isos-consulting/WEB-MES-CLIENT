...
export const PgMatReturnReport = () => {
  ...
  const searchInfo = useSearchbox('SEARCH_INPUTBOX', [
    {type:'daterange', id:'reg_date', ids:['start_date', 'end_date'], defaults:[getToday(-6), getToday()], label:'반출일'},
    ...
    switch (searchInfo.values?.sort_type) {
      ...
      case 'prod':
        _columns = [
          ...
          {header: '합계금액', name:'total_price', width:ENUM_WIDTH.L, filter:'number', format:'number'},
