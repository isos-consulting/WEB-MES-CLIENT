...
export const PgInvStoresIndividualHistory = () => {
  ...
  const columns:IGridColumn[] = [
    {header: '수불일시', name:'reg_date', width:ENUM_WIDTH.M, filter:'text', format:'date'},
    {header: '품번', width:ENUM_WIDTH.L, name:'prod_no', filter:'text', align:'center'},
    ...
    {header: '창고', width:ENUM_WIDTH.S, name:'store_nm', filter:'text', align:'center'},
    {header: '위치', width:ENUM_WIDTH.M, name:'location_nm', format:'number', filter:'number'},
    {header: '수불유형', name:'tran_nm', width:ENUM_WIDTH.M, filter:'text'},
    {header: '기초재고수량', name:'basic_stock', width:ENUM_WIDTH.M, filter:'text'},
    {header: '입고수량', width:ENUM_WIDTH.XL, name:'in_qty', filter:'text'},
    {header: '출고수량', width:ENUM_WIDTH.XL, name:'out_qty', filter:'text'},
    {header: '변경수량', width:ENUM_WIDTH.XL, name:'update_qty', filter:'text'},
    {header: '기말재고수량', width:ENUM_WIDTH.XL, name:'final_stock', filter:'text'},
  ];
