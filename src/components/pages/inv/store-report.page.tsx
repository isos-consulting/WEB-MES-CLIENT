...
export const PgInvStoreReport = () => {
  ...
  const searchInfo = useSearchbox('SEARCH_INPUTBOX', [
    {type:'daterange', id:'reg_date', ids:['start_date', 'end_date'], defaults:[getToday(-7), getToday()], label:'실사일'},
    {
      type:'combo',
      id:'store_uuid', 
      label:'입고창고', 
  ...
  const columns:IGridColumn[] = [
    {header: '실사일', name:'reg_date', width:ENUM_WIDTH.M, filter:'text', format:'date'},
    {header: '품목유형', width:ENUM_WIDTH.L, name:'item_type_nm', filter:'text', align:'center'},
    ...
    {header: '입출고 유형', width:ENUM_WIDTH.S, name:'inout_state', filter:'text', align:'center'},
    {header: '실사수량', width:ENUM_WIDTH.M, name:'qty', format:'number', filter:'number'},
    {header: '창고명', name:'store_nm', width:ENUM_WIDTH.M, filter:'text'},
    {header: '위치명', name:'location_nm', width:ENUM_WIDTH.M, filter:'text'},
