...
export const PgInvStoresStocks = () => {
  ...
  const columns:IGridColumn[] = [
    ...
    {header: '외주거래처', width:ENUM_WIDTH.L, name:'outsourcing_partner_nm', filter:'text'},
    {header: '창고명', width:ENUM_WIDTH.M, name:'store_nm', filter:'text'},
    {header: '위치명', width:ENUM_WIDTH.M, name:'location_nm', filter:'text'},
    {header: '부적합', width:ENUM_WIDTH.M, name:'reject_nm', filter:'text'},
    {header: 'LOT NO', width:ENUM_WIDTH.L, name:'lot_no', filter:'text'},
    {header: '재고', width:ENUM_WIDTH.M, name:'qty', format:'number', filter:'number'},
  ];
