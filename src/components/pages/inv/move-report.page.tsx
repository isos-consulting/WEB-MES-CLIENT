...
export const PgInvMoveReport = () => {
  ...
  const columns:IGridColumn[] = [
    {header: '이동일', width:ENUM_WIDTH.M, name:'reg_date', filter:'text', align:'center', format:'date'},
    ...
    {header: '출고창고', width:ENUM_WIDTH.L, name:'from_store_nm', filter:'text'},
    {header: '출고위치', width:ENUM_WIDTH.M, name:'from_location_nm', filter:'text'},
    {header: '입고창고', width:ENUM_WIDTH.L, name:'to_store_nm', filter:'text'},
    {header: '입고위치', width:ENUM_WIDTH.M, name:'to_location_nm', filter:'text'},
    {header: 'LOT NO', width:ENUM_WIDTH.L, name:'lot_no', filter:'text'},
    {header: '이동수량', width:ENUM_WIDTH.M, name:'qty', format:'number', filter:'number'},
