...
export const PgSalOutgo = () => {
  ...
  const headerGrid = useGrid('HEADER_GRID', [
    {header: '제품출하UUID', name:'outgo_uuid', alias:'uuid', hidden:true},
    {header: '전표번호', name:'stmt_no', width:ENUM_WIDTH.M, format:'text'},
    {header: '출하일', name:'reg_date', width:ENUM_WIDTH.M, format:'date'},
  ...
  const detailInputInfo = useInputGroup('DETAIL_INPUTBOX', [
    {type: 'text', id: 'outgo_uuid', alias:'uuid', label: '출하UUID', disabled:true, hidden:true},
    {type:'date', id:'reg_date', label:'출하일', disabled:true, default:getToday()},
