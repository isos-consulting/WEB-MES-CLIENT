...
export const PgStdVendorPrice = () => {
  ...
  const detailGrid = useGrid('DETAIL_GRID', [
    {header: '협력사 단가UUID', name:'vendor_price_uuid', alias:'uuid', width:ENUM_WIDTH.M, hidden:true},
    ...
    {header: '단위', name:'unit_nm', width:ENUM_WIDTH.S, format:'popup', filter:'text', editable:true, requiredField:true},
    {header: '입고 창고UUID', name:'to_store_uuid', width:ENUM_WIDTH.M, hidden:true},
    {header: '입고 창고', name:'to_store_nm', width:ENUM_WIDTH.M, format:'popup', filter:'text', editable:true, hidden:true},
    {header: '입고 위치UUID', name:'to_location_uuid', width:ENUM_WIDTH.M, hidden:true},
    {header: '입고 위치', name:'to_location_nm', width:ENUM_WIDTH.M, format:'popup', filter:'text', editable:true, hidden:true},
    {header: '화폐단위UUID', name:'money_unit_uuid', width:ENUM_WIDTH.M, hidden:true},
    ...
    {header: '단가', name:'price', width:ENUM_WIDTH.M, format:'number', filter:'number', decimal:3, editable:true, requiredField:true},
  ...
  const detailInputInfo = useInputGroup('DETAIL_INPUTBOX', [
    {type:'text', id:'partner_uuid', label:'고객사UUID', hidden:true, disabled:true},
    {type:'text', id:'partner_nm', label:'고객사', usePopup:true, disabled:true, popupKey:'거래처관리', popupKeys:['partner_uuid', 'partner_nm']},
  ]);
