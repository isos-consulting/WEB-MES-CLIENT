...
export const PgStdInspTool = () => {
  ...
  const grid = useGrid('GRID', [
    {header: '검사구UUID', name:'insp_tool_uuid', alias:'uuid', width:ENUM_WIDTH.L, filter:'text', hidden:true},
    {header: '검사구코드', name:'insp_tool_cd', width:ENUM_WIDTH.M, filter:'text', editable:true, requiredField:true},
    {header: '검사구명', name:'insp_tool_nm', width:ENUM_WIDTH.L, filter:'text', editable:true, requiredField:true},
  ], {
