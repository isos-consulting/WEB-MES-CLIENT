...
export const PgStdMoneyUnit = () => {
  ...
  const searchUriPath = '/std/money-units';
  const saveUriPath = '/std/money-units';

  /** 그리드 상태를 관리 */
  const grid = useGrid('GRID', [
    {header: '화폐단위UUID', name:'money_unit_uuid', alias:'uuid', width:ENUM_WIDTH.L, filter:'text', hidden:true},
    {header: '화폐단위코드', name:'money_unit_cd', width:ENUM_WIDTH.M, filter:'text', editable:true, requiredField:true},
    {header: '화폐단위명', name:'money_unit_nm', width:ENUM_WIDTH.L, filter:'text', editable:true, requiredField:true},
  ], {
