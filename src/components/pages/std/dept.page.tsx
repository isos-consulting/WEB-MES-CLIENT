...
export const PgStdDept = () => {
  ...
  const searchUriPath = '/std/depts';
  const saveUriPath = '/std/depts';

  /** 그리드 상태를 관리 */
  const grid = useGrid('GRID', [
    {header: '부서UUID', name:'dept_uuid', alias:'uuid', width:ENUM_WIDTH.L, filter:'text', hidden:true},
    {header: '부서코드', name:'dept_cd', width:ENUM_WIDTH.M, filter:'text', editable:true, requiredField:true},
    {header: '부서명', name:'dept_nm', width:ENUM_WIDTH.L, filter:'text', editable:true, requiredField:true},
  ], {
