...
export const PgStdFactory = () => {
  ...
  const searchUriPath = '/std/factories';
  const saveUriPath = '/std/factories';

  /** 그리드 상태를 관리 */
  const grid = useGrid('GRID', [
    {header: '공장UUID', name:'factory_uuid', alias:'uuid', width:150, filter:'text', hidden:true},
    {header: '공장코드', name:'factory_cd', width:150, filter:'text', editable:true, requiredField:true},
    {header: '공장명', name:'factory_nm', width:200, filter:'text', editable:true, requiredField:true},
  ], {
