...
export const PgStdShift = () => {
  ...
  const grid = useGrid('GRID', [
    {header: '작업교대UUID', name:'shift_uuid', alias:'uuid', width:ENUM_WIDTH.L, filter:'text', hidden:true},
    {header: '작업교대코드', name:'shift_cd', width:ENUM_WIDTH.M, filter:'text', editable:true, requiredField:true},
    {header: '작업교대명', name:'shift_nm', width:ENUM_WIDTH.L, filter:'text', editable:true, requiredField:true},
    {header: '시작시간', name:'start_time', width:ENUM_WIDTH.M, format:'time', editable:true, requiredField:true},
    {header: '종료시간', name:'end_time', width:ENUM_WIDTH.M, format:'time', editable:true, requiredField:true},
  ], {
