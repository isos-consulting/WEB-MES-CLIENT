...
export const PgStdDelivery = () => {
  ...
  const searchUriPath = '/std/deliveries';
  const saveUriPath = '/std/deliveries';

  /** 그리드 상태를 관리 */
  const grid = useGrid('GRID', [
    {header: '납품처UUID', name:'delivery_uuid', alias:'uuid', width:ENUM_WIDTH.L, hidden:true},
    {header: '납품처코드', name:'delivery_cd', width:ENUM_WIDTH.M, filter:'text', editable:true, requiredField:true},
    ...
    {header: '팩스번호', name:'fax', width:ENUM_WIDTH.M, filter:'text', editable:true},
