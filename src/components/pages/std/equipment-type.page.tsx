...
/** 설비유형관리 */
export const PgStdEquipmentType = () => {
  /** 페이지 제목 */
  ...
  const searchUriPath = '/std/equip-types';
  const saveUriPath = '/std/equip-types';

  /** 그리드 상태를 관리 */
  const grid = useGrid('GRID', [
    {header: '설비유형UUID', name:'equip_type_uuid', alias:'uuid', width:ENUM_WIDTH.L, filter:'text', hidden:true},
    {header: '설비유형코드', name:'equip_type_cd', width:ENUM_WIDTH.M, filter:'text', editable:true, requiredField:true},
    {header: '설비유형명', name:'equip_type_nm', width:ENUM_WIDTH.L, filter:'text', editable:true, requiredField:true},
  ], {
