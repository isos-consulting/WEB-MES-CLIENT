...
export const PgStdRejectType = () => {
  ...
  const searchUriPath = '/std/reject-types';
  const saveUriPath = '/std/reject-types';

  /** 그리드 상태를 관리 */
  const grid = useGrid('GRID', [
    {header: '부적합유형UUID', name:'reject_type_uuid', alias:'uuid', width:ENUM_WIDTH.L, filter:'text', hidden:true},
    {header: '부적합유형코드', name:'reject_type_cd', width:ENUM_WIDTH.M, filter:'text', editable:true, requiredField:true},
    {header: '부적합유형명', name:'reject_type_nm', width:ENUM_WIDTH.L, filter:'text', editable:true, requiredField:true},
  ], {
