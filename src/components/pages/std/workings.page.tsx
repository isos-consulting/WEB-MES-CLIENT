...
export const PgStdWorkings = () => {
  ...
  const grid = useGrid('GRID', [
    {header: '작업장UUID', name:'workings_uuid', alias:'uuid', width:ENUM_WIDTH.L, filter:'text', hidden:true},
    {header: '작업장코드', name:'workings_cd', width:ENUM_WIDTH.M, filter:'text', editable:true, requiredField:true},
    {header: '작업장명', name:'workings_nm', width:ENUM_WIDTH.L, filter:'text', editable:true, requiredField:true},
  ], {
