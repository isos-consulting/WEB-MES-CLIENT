...
/** 비가동유형관리 */
export const PgStdDowntimeType = () => {
  /** 페이지 제목 */
  ...
  const searchUriPath = '/std/downtime-types';
  const saveUriPath = '/std/downtime-types';

  /** 그리드 상태를 관리 */
  const grid = useGrid('GRID', [
    {header: '비가동 유형UUID', name:'downtime_type_uuid', alias:'uuid', width:ENUM_WIDTH.L, filter:'text', hidden:true},
    {header: '비가동 유형코드', name:'downtime_type_cd', width:ENUM_WIDTH.M, filter:'text', editable:true, requiredField:true},
    {header: '비가동 유형명', name:'downtime_type_nm', width:ENUM_WIDTH.L, filter:'text', editable:true, requiredField:true},
  ], {
