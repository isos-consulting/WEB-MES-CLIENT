...
export const PgStdGrade = () => {
  ...
  const searchUriPath = '/std/grades';
  const saveUriPath = '/std/grades';

  /** 그리드 상태를 관리 */
  const grid = useGrid('GRID', [
    {header: '직급UUID', name:'grade_uuid', alias:'uuid', width:ENUM_WIDTH.L, filter:'text', hidden:true},
    {header: '직급코드', name:'grade_cd', width:ENUM_WIDTH.M, filter:'text', editable:true, requiredField:true},
    {header: '직급명', name:'grade_nm', width:ENUM_WIDTH.L, filter:'text', editable:true, requiredField:true},
  ], {
