...
export const PgStdProcEquip = () => {
  ...
  const detailGrid = useGrid('DETAIL_GRID', [
    {header: '공정별 설비정보UUID', name:'proc_equip_uuid', alias:'uuid', width:ENUM_WIDTH.M, hidden:true},
    {header: '공정UUID', name:'proc_uuid', width:ENUM_WIDTH.M, hidden:true},
    {header: '공정코드', name:'proc_cd', width:ENUM_WIDTH.M, filter:'text', hidden:true},
    {header: '공정명', name:'proc_nm', width:ENUM_WIDTH.L, filter:'text', hidden:true},
    {header: '설비유형UUID', name:'equip_type_uuid', width:ENUM_WIDTH.M, hidden:true},
    ...
    {header: '설비코드', name:'equip_cd', width:ENUM_WIDTH.M, format:'popup', editable:true},
    {header: '설비명', name:'equip_nm', width:ENUM_WIDTH.L, format:'popup', filter:'text', editable:true, requiredField:true},
  ], {
  ...
  const equipPopupInfo = {
    ...
    columns: [
      {header: '설비유형UUID', name:'equip_type_uuid', width:ENUM_WIDTH.M, format:'text', hidden:true},
      {header: '설비유형코드', name:'equip_type_cd', width:ENUM_WIDTH.M, format:'text', hidden:true},
      {header: '설비유형명', name:'equip_type_nm', width:ENUM_WIDTH.L, format:'text'},
      {header: '설비UUID', name:'equip_uuid', width:ENUM_WIDTH.M, format:'text', hidden:true},
      {header: '설비코드', name:'equip_cd', width:ENUM_WIDTH.M, format:'text'},
      {header: '설비명', name:'equip_nm', width:ENUM_WIDTH.L, format:'text'},
    ],
    dataApiSettings: {
      uriPath: '/std/equips',
      params: {}
