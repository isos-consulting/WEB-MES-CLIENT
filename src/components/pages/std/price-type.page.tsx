...
export const PgStdPriceType = () => {
  ...
  const searchUriPath = '/std/price-types';
  const saveUriPath = '/std/price-types';

  /** 그리드 상태를 관리 */
  const grid = useGrid('GRID', [
    {header: '단가유형UUID', name:'price_type_uuid', alias:'uuid', width:ENUM_WIDTH.L, filter:'text', hidden:true},
    {header: '단가유형코드', name:'price_type_cd', width:ENUM_WIDTH.M, filter:'text', editable:true, requiredField:true},
    {header: '단가유형명', name:'price_type_nm', width:ENUM_WIDTH.L, filter:'text', editable:true, requiredField:true},
  ], {
