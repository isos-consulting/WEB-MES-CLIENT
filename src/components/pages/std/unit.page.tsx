...
export const PgStdUnit = () => {
  ...
  const searchUriPath = '/std/units';
  const saveUriPath = '/std/units';

  /** 그리드 상태를 관리 */
  const grid = useGrid('GRID', [
    {header: '단위UUID', name:'unit_uuid', alias:'uuid', width:ENUM_WIDTH.L, filter:'text', hidden:true},
    {header: '단위코드', name:'unit_cd', width:ENUM_WIDTH.M, filter:'text', editable:true, requiredField:true},
    {header: '단위명', name:'unit_nm', width:ENUM_WIDTH.L, filter:'text', editable:true, requiredField:true},
  ], {
