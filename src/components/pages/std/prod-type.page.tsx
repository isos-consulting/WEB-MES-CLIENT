...
export const PgStdProdType = () => {
  ...
  const searchUriPath = '/std/prod-types';
  const saveUriPath = '/std/prod-types';

  /** 그리드 상태를 관리 */
  const grid = useGrid('GRID', [
    {header: '제품유형UUID', name:'prod_type_uuid', alias:'uuid', width:ENUM_WIDTH.L, filter:'text', hidden:true},
    {header: '제품유형코드', name:'prod_type_cd', width:ENUM_WIDTH.M, filter:'text', editable:true, requiredField:true},
    {header: '제품유형명', name:'prod_type_nm', width:ENUM_WIDTH.L, filter:'text', editable:true, requiredField:true},
  ], {
