...
export const PgStdModel = () => {
  ...
  const searchUriPath = '/std/models';
  const saveUriPath = '/std/models';

  /** 그리드 상태를 관리 */
  const grid = useGrid('GRID', [
    {header: '모델UUID', name:'model_uuid', alias:'uuid', width:ENUM_WIDTH.L, filter:'text', hidden:true},
    {header: '모델코드', name:'model_cd', width:ENUM_WIDTH.M, filter:'text', editable:true, requiredField:true},
    {header: '모델명', name:'model_nm', width:ENUM_WIDTH.L, filter:'text', editable:true, requiredField:true},
  ], {
