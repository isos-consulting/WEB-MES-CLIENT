...
export const PgStdLocation = () => {
  ...
  const grid = useGrid('GRID', [
    {header: '창고UUID', name:'store_uuid', width:ENUM_WIDTH.L, filter:'text', editable:true, hidden:true},
    {header: '창고코드', name:'store_cd', width:ENUM_WIDTH.M, filter:'text', editable:true, hidden:true},
    {header: '창고명', name:'store_nm', width:ENUM_WIDTH.L, format:'popup', filter:'text', editable:true, requiredField:true},
    {header: '위치UUID', name:'location_uuid', alias:'uuid', width:ENUM_WIDTH.L, hidden:true},
    {header: '위치코드', name:'location_cd', width:ENUM_WIDTH.M, filter:'text', editable:true, requiredField:true},
    {header: '위치명', name:'location_nm', width:ENUM_WIDTH.L, filter:'text', editable:true, requiredField:true},
  ], {
