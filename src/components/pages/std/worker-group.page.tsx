...
export const PgStdWorkerGroup = () => {
  ...
  const searchUriPath = '/std/worker-groups';
  const saveUriPath = '/std/worker-groups';

  /** 그리드 상태를 관리 */
  const grid = useGrid('GRID', [
    {header: '작업조UUID', name:'worker_group_uuid', alias:'uuid', width:ENUM_WIDTH.L, filter:'text', hidden:true},
    {header: '작업조코드', name:'worker_group_cd', width:ENUM_WIDTH.M, filter:'text', editable:true, requiredField:true},
    {header: '작업조명', name:'worker_group_nm', width:ENUM_WIDTH.L, filter:'text', editable:true, requiredField:true},
  ], {
