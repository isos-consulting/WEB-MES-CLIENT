...
export const PgStdProcReject = () => {
  ...
  const detailGrid = useGrid('DETAIL_GRID', [
    {header: '공정별 부적합UUID', name:'proc_reject_uuid', alias:'uuid', width:ENUM_WIDTH.M, hidden:true},
    ...
    {header: '부적합 유형UUID', name:'reject_type_uuid', width:ENUM_WIDTH.M, hidden:true},
    {header: '부적합 유형코드', name:'reject_type_cd', width:ENUM_WIDTH.M, hidden:true},
    {header: '부적합 유형명', name:'reject_type_nm', width:ENUM_WIDTH.M, format:'popup', filter:'text', editable:true},
    {header: '부적합UUID', name:'reject_uuid', width:ENUM_WIDTH.M, hidden:true},
    {header: '부적합코드', name:'reject_cd', width:ENUM_WIDTH.M, format:'popup', editable:true},
    {header: '부적합명', name:'reject_nm', width:ENUM_WIDTH.L, format:'popup', filter:'text', editable:true, requiredField:true},
