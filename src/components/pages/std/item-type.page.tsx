...
export const PgStdItemType = () => {
  ...
  const searchUriPath = '/std/item-types';
  const saveUriPath = '/std/item-types';

  /** 그리드 상태를 관리 */
  const grid = useGrid('GRID', [
    {header: '품목유형UUID', name:'item_type_uuid', alias:'uuid', width:ENUM_WIDTH.L, filter:'text', hidden:true},
    {header: '품목유형코드', name:'item_type_cd', width:ENUM_WIDTH.M, filter:'text', editable:true, requiredField:true},
    {header: '품목유형명', name:'item_type_nm', width:ENUM_WIDTH.L, filter:'text', editable:true, requiredField:true},
  ], {
