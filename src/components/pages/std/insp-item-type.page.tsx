...
/** 검사항목유형관리 */
export const PgStdInspItemType = () => {
  /** 페이지 제목 */
  ...
  const searchUriPath = '/std/insp-item-types';
  const saveUriPath = '/std/insp-item-types';

  /** 그리드 상태를 관리 */
  const grid = useGrid('GRID', [
    {header: '검사항목유형UUID', name:'insp_item_type_uuid', alias:'uuid', width:ENUM_WIDTH.L, filter:'text', hidden:true},
    {header: '검사항목유형코드', name:'insp_item_type_cd', width:ENUM_WIDTH.M, filter:'text', editable:true, requiredField:true},
    {header: '검사항목유형명', name:'insp_item_type_nm', width:ENUM_WIDTH.L, filter:'text', editable:true, requiredField:true},
  ], {
