...
export const PgStdProcess = () => {
  ...
  const searchUriPath = '/std/procs';
  const saveUriPath = '/std/procs';

  /** 그리드 상태를 관리 */
  const grid = useGrid('GRID', [
    {header: '공정UUID', name:'proc_uuid', alias:'uuid', width:ENUM_WIDTH.L, filter:'text', hidden:true},
    {header: '공정코드', name:'proc_cd', width:ENUM_WIDTH.M, filter:'text', editable:true, requiredField:true},
    {header: '공정명', name:'proc_nm', width:ENUM_WIDTH.L, filter:'text', editable:true, requiredField:true},
  ], {
