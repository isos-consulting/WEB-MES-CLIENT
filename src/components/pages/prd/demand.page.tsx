...
export const PgPrdDemand = () => {
  ...
  const grid = useGrid('GRID', [
    ...
    {header:'요청유형', name:'demand_type_nm', width:ENUM_WIDTH.M, format:'popup', filter:'text', editable:true},
    ...
    {header:'수량', name:'qty', width:ENUM_WIDTH.M, format:'number', filter:'number', editable:true},
    ...
    {header:'입고요청창고', name:'to_store_nm', width:ENUM_WIDTH.M, format:'popup', filter:'text', editable:true},
