...
export const orderInput = () => {
    ...
    gridComboInfo: [
      {
        ...
        columnNames: [
          {
            codeColName: { original: 'unit_uuid', popup: 'unit_uuid' },
            textColName: { original: 'unit_nm', popup: 'unit_nm' },
          },
        ],
        dataApiSettings: {
          uriPath: '/std/units',
  ...
  const onSearch = () => {
    getData(saveOptionParams, gridInfo.searchUriPath).then(res => {
      setData(res);
    });
  };
