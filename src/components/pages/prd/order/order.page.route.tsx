...
export const orderRoute = () => {
  ...
  const gridInfo:IDatagridProps = {
    ...
    columns: [
      ...
      {header:'작업지시UUID', name:'order_uuid', width:ENUM_WIDTH.M, hidden:true, format:'text'},
      {header:'공정UUID', name:'proc_uuid', width:ENUM_WIDTH.M, hidden:true, format:'text'},
      {header:'공정코드', name:'proc_cd', width:ENUM_WIDTH.M, hidden:true, format:'text', noSave:true},
      {header:'공정명', name:'proc_nm', width:ENUM_WIDTH.XL, hidden:false, editable:true, format:'popup', requiredField:true},
      {header:'작업장UUID', name:'workings_uuid', width:ENUM_WIDTH.M, hidden:true, format:'text'},
      {header:'작업장코드', name:'workings_cd', width:ENUM_WIDTH.M, hidden:true, format:'text', noSave:true},
      {header:'작업장명', name:'workings_nm', width:ENUM_WIDTH.L, editable:true, format:'popup', requiredField:true},
      {header:'금형UUID', name:'mold_uuid', width:ENUM_WIDTH.M, hidden:true, format:'text'},
      {header:'금형코드', name:'mold_cd', width:ENUM_WIDTH.M, hidden:true, format:'text', noSave:true},
      {header:'금형명', name:'mold_nm', width:ENUM_WIDTH.L, editable:true, format:'popup', noSave:true},
      {header:'금형Cavity', name:'cavity', width:ENUM_WIDTH.M, editable:true, format:'number'},
  ...
  const editGridPopupInfo:IGridPopupProps = {
    ...
    columns: [
      ...
      {header:'공정UUID', name:'proc_uuid', width:ENUM_WIDTH.M, hidden:true, format:'text'},
      {header:'공정코드', name:'proc_cd', width:ENUM_WIDTH.M, hidden:true, format:'text', noSave:true},
      {header:'공정명', name:'proc_nm', width:ENUM_WIDTH.XL, format:'popup', requiredField:true},
      {header:'작업장UUID', name:'workings_uuid', width:ENUM_WIDTH.M, hidden:true, format:'text'},
      {header:'작업장코드', name:'workings_cd', width:ENUM_WIDTH.M, hidden:true, format:'text', noSave:true},
      {header:'작업장명', name:'workings_nm', width:ENUM_WIDTH.L, editable:true, format:'popup', requiredField:true},
      {header:'금형UUID', name:'mold_uuid', width:ENUM_WIDTH.M, hidden:true, format:'text'},
