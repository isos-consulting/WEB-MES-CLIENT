...
const BaseWorkInfo = ({
  ...
  const changeStartDate = (ev) => {
    ...
    if (dayjs(datetime).isValid() === false || values?._start_time == null) datetime = null;

    infoDispatch({type:'CHANGE_ROUTING_INFO', name:'start_date', value:datetime});
  }
  ...
  const changeEndDate = (ev) => {
    ...
    if (dayjs(datetime).isValid() === false || values?._end_time == null) datetime = null;

    infoDispatch({type:'CHANGE_ROUTING_INFO', name:'end_date', value:datetime});
  }
  ...
  const changeCboLocation = (value) => {
    infoDispatch({type:'CHANGE_ROUTING_INFO', name:'to_location_uuid', value});
  }
    ...
    <div style={{padding:'0px 4px', marginTop:-10, width:'100%'}}>
      <Row gutter={[16,16]}>
        <Col span={6} style={{paddingLeft: 4}}>
          ...
          <Textbox {...textboxDefaultSettings} id='proc_nm' value={values?.proc_nm} widthSize='flex' disabled={true} />
        </Col>
        <Col span={6}>
          <Label text='공정순서' width={100} />
          <Textbox {...textboxDefaultSettings} id='proc_no' value={values?.proc_no} widthSize='flex' disabled={true} />
        </Col>
        <Col span={6}>
          <Label text='시작 일자' width={100} />
          <Textbox {...textboxDefaultSettings} type='date' id='start_date' value={values?._start_date} widthSize='flex' onChange={changeStartDate}  />
        </Col>
        <Col span={6} style={{paddingRight: 4}}>
          <Label text='시작 시간' width={100} />
          <Textbox {...textboxDefaultSettings} type='time' id='start_time' value={values?._start_time} widthSize='flex' onChange={changeStartTime} />
        </Col>
      </Row>
      <Row gutter={[16,16]}>
        <Col span={6} style={{paddingLeft: 4}}>
          ...
          <div style={{display:'flex'}}>
            <Textbox {...textboxDefaultSettings} id='workings_nm' value={values?.workings_nm} widthSize='flex' disabled={true} />
            <div style={{
              float:'right',
              marginLeft:-30}}>
              <PopupButton
        ...
        <Col span={6}>
          ...
          <div style={{display:'flex'}}>
            <Textbox {...textboxDefaultSettings} id='equip_nm' value={values?.equip_nm} widthSize='flex' disabled={true} />
            <div style={{
              float:'right',
              marginLeft:-30}}>
              <PopupButton
        ...
        <Col span={6}>
          ...
          <Textbox {...textboxDefaultSettings} type='date' id='end_date' value={values?._end_date} widthSize='flex' onChange={changeEndDate} />
        </Col>
        <Col span={6} style={{paddingRight: 4}}>
          <Label text='종료 시간' width={100} />
          <Textbox {...textboxDefaultSettings} type='time' id='end_time' value={values?._end_time} widthSize='flex' onChange={changeEndTime} />
        </Col>
      </Row>
      <Row gutter={[16,16]}>
        <Col span={6}  style={{paddingLeft: 4}}>
          <Label text='금형'/>
          <div style={{display:'flex'}}>
            <Textbox {...textboxDefaultSettings} id='mold_nm' value={values?.mold_nm} widthSize='flex' disabled={true} />
            <div style={{
              float:'right',
              marginLeft:-30}}>
              <PopupButton
        ...
        <Col span={3}>
          ...
          <Textbox {...textboxDefaultSettings} type='number' id='mold_cavity' value={values?.mold_cavity} widthSize='flex' onChange={changeCavity} />
        </Col>
        <Col span={3}>
