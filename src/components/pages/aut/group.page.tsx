...
export const PgAutGroup = () => {
  ...
  const searchUriPath = '/aut/groups';
  const saveUriPath = '/aut/groups';

  /** 그리드 상태를 관리 */
  const grid = useGrid('GRID', [
    {header: '권한그룹UUID', name:'group_uuid', alias:'uuid', width:ENUM_WIDTH.M, filter:'text', hidden:true},
    {header: '권한그룹명', name:'group_nm', width:ENUM_WIDTH.L, filter:'text', editable:true, requiredField:true},
  ], {
