...
const menuGridComboCodeColName = {
  original: 'menu_type_uuid',
  popup: 'menu_type_uuid',
};
const menuGridComboTextColName = {
  original: 'menu_type_nm',
  popup: 'menu_type_nm',
};

const gridComboColumnNames = [
  {
    codeColName: menuGridComboCodeColName,
...
const menuGridTreeColumnOptions = {
  name: 'menu_nm',
  useIcon: true,
...
export const menuGridOptions = {
  treeColumnOptions: menuGridTreeColumnOptions,
  gridComboInfo: menuGridComboInfo,
};
...
const menuGridRowAddPopupInfo: IGridPopupInfo = {
  gridMode: 'select',
  columnNames: menuGridRowColumnNames,
};
const menuGridSettings: IDatagridProps = {
  gridId: '',
  columns: [],
  rowAddPopupInfo: menuGridRowAddPopupInfo,
};
...
const menuGridRowAddPopupInfo2: IGridPopupInfo = {
  gridMode: 'select',
  columnNames: menuGridRowColumnNames2,
};
const menuGridSettings2: IDatagridProps = {
  gridId: '',
  columns: [],
  rowAddPopupInfo: menuGridRowAddPopupInfo2,
};
...
export const menuInputGroupBoxs: IInputGroupboxItem[] = [
  {
    ...
    usePopup: true,
    popupKey: '메뉴관리',
    popupKeys: ['parent_uuid', 'parent_nm'],
    popupButtonSettings: menuGridPopupButtonSettings,
  },
  {
    type: 'text',
    id: 'parent_uuid',
  ...
  },
  {
    ...
    popupButtonSettings: menuGridPopupButtonSettings2,
    required: true,
  },
  {
    type: 'text',
  ...
  },
  {
    type: 'text',
    id: 'menu_type_uuid',
    label: 'menu_type_uuid',
    disabled: false,
    hidden: true,
  },
  { type: 'text', id: 'menu_uri', label: '메뉴 URI', required: true },
