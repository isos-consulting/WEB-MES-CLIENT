...
export const PgAutPermission = () => {
  ...
  const grid = useGrid('GRID', [
    {header: '권한UUID', name:'permission_uuid', alias:'uuid', width:ENUM_WIDTH.M, filter:'text', hidden:true},
    {header: '권한명', name:'permission_nm', width:ENUM_WIDTH.L, filter:'text', editable:true, requiredField:true},
    {header: '생성 권한', name:'create_fg', width:ENUM_WIDTH.S, format: 'check', filter:'text', editable:true, requiredField:true},
    {header: '조회 권한', name:'read_fg', width:ENUM_WIDTH.S, format: 'check', filter:'text', editable:true, requiredField:true},
    {header: '수정 권한', name:'update_fg', width:ENUM_WIDTH.S, format: 'check', filter:'text', editable:true, requiredField:true},
    {header: '삭제 권한', name:'delete_fg', width:ENUM_WIDTH.S, format: 'check', filter:'text', editable:true, requiredField:true},
  ], {
