...
type TranType = 'all' | 'matIncome' | 'matReturn' | 'matRelease' | 'prdReturn' | 'prdOutput' | 'prdInput' | 'prdReject' | 'salIncome' | 'salRelease' | 'salOutgo' | 'salReturn' | 'outIncome' | 'outRelease' | 'inventory' | 'invMove' | 'invReject' | 'qmsReceiveInspReject' | 'qmsFinalInspIncome' | 'qmsFinalInspReject' | 'qmsRework' | 'qmsDisposal' | 'qmsReturn' | 'qmsDisassemble' | 'qmsDisassembleIncome' | 'qmsDisassembleReturn' | 'etcIncome' | 'etcRelease' 
